...
public interface NotificationService {
    ...
    void walletActivityNotification(User user, TransactionLog transactionLog);

    void taskCompletionNotification(Task task, User user);

    void taskerApprovalNotification( Task task, User user);
